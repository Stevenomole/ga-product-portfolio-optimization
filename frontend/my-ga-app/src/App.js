                        ...
                        <div className="selected-products">
                            ...
                            <ul>
                                {Object.entries(products).map(([family, product]) => (
                                    <li key={family}>
                                        <span className="product-name">Family {family}: Product {Object.keys(product)[0]}</span>
                                        <span className="product-cost">{formatMoney(Object.values(product)[0])}</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
